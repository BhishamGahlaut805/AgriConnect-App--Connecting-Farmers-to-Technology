...
# current_rain = current.Variables(8).Value()
# current_showers = current.Variables(9).Value()
# current_snowfall = current.Variables(10).Value()
# current_surface_pressure = current.Variables(11).Value()
# current_pressure_msl = current.Variables(12).Value()
# current_cloud_cover = current.Variables(13).Value()
# current_weather_code = current.Variables(14).Value()
...
# minutely_15_cape = minutely_15.Variables(7).ValuesAsNumpy()
# minutely_15_lightning_potential = minutely_15.Variables(8).ValuesAsNumpy()
# minutely_15_is_day = minutely_15.Variables(9).ValuesAsNumpy()
# minutely_15_shortwave_radiation = minutely_15.Variables(10).ValuesAsNumpy()
# minutely_15_direct_radiation = minutely_15.Variables(11).ValuesAsNumpy()
# minutely_15_diffuse_radiation = minutely_15.Variables(12).ValuesAsNumpy()
# minutely_15_direct_normal_irradiance = minutely_15.Variables(13).ValuesAsNumpy()
# minutely_15_global_tilted_irradiance = minutely_15.Variables(14).ValuesAsNumpy()
# minutely_15_terrestrial_radiation = minutely_15.Variables(15).ValuesAsNumpy()
# minutely_15_rain = minutely_15.Variables(16).ValuesAsNumpy()
# minutely_15_snowfall = minutely_15.Variables(17).ValuesAsNumpy()
# minutely_15_snowfall_height = minutely_15.Variables(18).ValuesAsNumpy()
# minutely_15_freezing_level_height = minutely_15.Variables(19).ValuesAsNumpy()
# minutely_15_sunshine_duration = minutely_15.Variables(20).ValuesAsNumpy()
# minutely_15_weather_code = minutely_15.Variables(21).ValuesAsNumpy()
# minutely_15_wind_speed_10m = minutely_15.Variables(22).ValuesAsNumpy()
# minutely_15_wind_speed_80m = minutely_15.Variables(23).ValuesAsNumpy()
# minutely_15_wind_direction_10m = minutely_15.Variables(24).ValuesAsNumpy()
# minutely_15_wind_direction_80m = minutely_15.Variables(25).ValuesAsNumpy()
...
# hourly_relative_humidity_200hPa = hourly.Variables(91).ValuesAsNumpy()
# hourly_relative_humidity_250hPa = hourly.Variables(92).ValuesAsNumpy()
# hourly_relative_humidity_300hPa = hourly.Variables(93).ValuesAsNumpy()
# hourly_relative_humidity_400hPa = hourly.Variables(94).ValuesAsNumpy()
# hourly_relative_humidity_500hPa = hourly.Variables(95).ValuesAsNumpy()
# hourly_relative_humidity_600hPa = hourly.Variables(96).ValuesAsNumpy()
# hourly_relative_humidity_700hPa = hourly.Variables(97).ValuesAsNumpy()
...
# hourly_cloud_cover_30hPa = hourly.Variables(117).ValuesAsNumpy()
# hourly_cloud_cover_50hPa = hourly.Variables(118).ValuesAsNumpy()
# hourly_cloud_cover_70hPa = hourly.Variables(119).ValuesAsNumpy()
# hourly_cloud_cover_100hPa = hourly.Variables(120).ValuesAsNumpy()
# hourly_cloud_cover_150hPa = hourly.Variables(121).ValuesAsNumpy()
...
# hourly_wind_speed_200hPa = hourly.Variables(129).ValuesAsNumpy()
# hourly_wind_speed_250hPa = hourly.Variables(130).ValuesAsNumpy()
# hourly_wind_speed_300hPa = hourly.Variables(131).ValuesAsNumpy()
# hourly_wind_speed_400hPa = hourly.Variables(132).ValuesAsNumpy()
# hourly_wind_speed_500hPa = hourly.Variables(133).ValuesAsNumpy()
# hourly_wind_speed_600hPa = hourly.Variables(134).ValuesAsNumpy()
# hourly_wind_speed_700hPa = hourly.Variables(135).ValuesAsNumpy()
...
# hourly_wind_direction_200hPa = hourly.Variables(148).ValuesAsNumpy()
# hourly_wind_direction_250hPa = hourly.Variables(149).ValuesAsNumpy()
# hourly_wind_direction_300hPa = hourly.Variables(150).ValuesAsNumpy()
# hourly_wind_direction_400hPa = hourly.Variables(151).ValuesAsNumpy()
# hourly_wind_direction_500hPa = hourly.Variables(152).ValuesAsNumpy()
# hourly_wind_direction_600hPa = hourly.Variables(153).ValuesAsNumpy()
# hourly_wind_direction_700hPa = hourly.Variables(154).ValuesAsNumpy()
...
# hourly_geopotential_height_30hPa = hourly.Variables(174).ValuesAsNumpy()
# hourly_geopotential_height_50hPa = hourly.Variables(175).ValuesAsNumpy()
# hourly_geopotential_height_70hPa = hourly.Variables(176).ValuesAsNumpy()
# hourly_geopotential_height_100hPa = hourly.Variables(177).ValuesAsNumpy()
# hourly_geopotential_height_150hPa = hourly.Variables(178).ValuesAsNumpy()
...
# daily_et0_fao_evapotranspiration = daily.Variables(9).ValuesAsNumpy()
...
# daily_uv_index_max = daily.Variables(14).ValuesAsNumpy()
# daily_uv_index_clear_sky_max = daily.Variables(15).ValuesAsNumpy()
...
# daily_precipitation_probability_max = daily.Variables(21).ValuesAsNumpy()
