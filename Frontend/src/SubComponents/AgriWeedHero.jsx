  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center py-16 px-6 md:px-12 text-white">
        ...
        >
          🌱 <span className="text-yellow-300">AgriWeed AI</span> - Powered by
          AGRIConnect
        </motion.h1>

        {/* Subtitle */}
        <p className="mt-4 text-lg md:text-2xl text-yellow-100 max-w-3xl mx-auto font-medium">
          AI-powered weed detection for{" "}
          <span className="font-semibold text-yellow-300">cotton crops</span>.
          Supports image upload, video analysis, and live field monitoring.
        </p>
        ...
        <p className="mt-8 text-lg text-gray-100 italic max-w-2xl mx-auto">
          “Empowering cotton farmers with real-time insights, advanced AI
