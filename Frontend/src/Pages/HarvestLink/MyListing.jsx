...
export default function MyListings() {
  ...
  // In MyListing.jsx - Fix the fetchListings function
  const fetchListings = async () => {
    try {
      ...
      const response = await AgrimarketService.ListingService.mine(user_id);
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="px-3 py-2 font-bold text-gray-600 flex flex-row justify-between bg-gray-100 dark:bg-slate-700 rounded mb-4">
                        <div className="px-3 py-2 font-bold text-gray-600 bg-green-300 dark:bg-green-900 rounded mr-4">
                          <a
                            href={`/harvestLink/product/${listing.product._id}`}
