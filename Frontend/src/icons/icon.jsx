...
// Lucide Icons (Google-style alternative)
import {
  Leaf as LeafIcon,
...
export const FarmerIcon = ({ className }) => (
...
export const FarmIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M22 12v8h-2v-2h-2v2h-2v-8h-2v-2h2V8h-2V6h2V4h-2V2h-2v2h-2v2h2v2h-2v2h2v2h-2v2h-2v-2h-2v2h-2v-2H8v2H6v-2H4v2H2v8h2v-2h2v2h2v-2h2v2h2v-8h2v-2h2v2h2v8h2v-2h2v2h2v-8zM6 16H4v-2h2v2zm4 0H8v-2h2v2zm4 0h-2v-2h2v2zm4 0h-2v-2h2v2z" />
  </svg>
);
